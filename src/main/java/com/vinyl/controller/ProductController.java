...
@Api(value="Product Management", description="Operations pertaining to products in Product Management System")
@RestController
public class ProductController {
    ...
    @ApiOperation(value = "Add a product to the shopping cart", response = ResponseEntity.class)
    @ApiResponses(value = {
